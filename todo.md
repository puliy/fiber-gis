...
## Баги — рисование кабеля и здания

- [ ] Рисование кабеля: двойной клик должен завершать рисование и открывать диалог сохранения
- [ ] Рисование здания: двойной клик должен завершать рисование и открывать диалог сохранения
- [ ] Клик на другой объект карты во время рисования не должен сбрасывать рисование

## Баги — сессия 5
- [ ] Ошибка создания кабеля: TiDB не принимает числовой lengthCalc — нужно передавать строку
- [ ] Канализация: клик на нарисованную линию не открывает диалог атрибутов
